...
HD_PWD='D:/BakkArbeit/git/VivadoProject2/BakkArbeit2.runs/impl_4'
cd "$HD_PWD"
...
EAStep vivado -log PicoRV32_BD_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source PicoRV32_BD_wrapper.tcl -notrace
