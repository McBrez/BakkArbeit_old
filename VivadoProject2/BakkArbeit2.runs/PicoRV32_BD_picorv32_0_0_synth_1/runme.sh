...
HD_PWD='D:/BakkArbeit/git/VivadoProject2/BakkArbeit2.runs/PicoRV32_BD_picorv32_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PicoRV32_BD_picorv32_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PicoRV32_BD_picorv32_0_0.tcl
